...
class DriverAIController:
    def __init__(
        ...
        self.last_status: Dict[str, object] = {
            ...
            "huggingface": {"enabled": False, "emotion": "DISABLED", "score": 0.0, "backend": "disabled", "model": ""},
        }
        ...
        self._huggingface_status = self.ai_tracker.hf_emotion.idle_status()
        self.last_status["huggingface"] = self._huggingface_status
    ...
    def _live_signal_from_frame(self, frame) -> DriverBehaviorSignal:
        ...
        speed_kph = 82.0
        hf = ai_status.get("huggingface") or {}
        emotional_stress_score = float(hf.get("score") or 0.0) if hf.get("stress") else 0.0
        self._huggingface_status = hf
